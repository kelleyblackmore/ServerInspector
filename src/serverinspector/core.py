"""
Core functionality for serverinspector.
"""
...
from serverinspector.collectors.system_info import collect_system_info
...
class serverinspector:
    """
    Main class for the serverinspector tool.
    """
    ...
    def __init__(
        ...
        """
        Initialize serverinspector with the given configuration.
        ...
        logger.debug(
            f"Initialized serverinspector with runner: {self.runner.__class__.__name__}"
        )
