"""
serverinspector system checkers.
...
def get_checker(checker_type):
    ...
    """
    checker_map = {
        "file": "serverinspector.checkers.file",
        "directory": "serverinspector.checkers.file",  # Map directory type to file module
        "symlink": "serverinspector.checkers.file",  # Map symlink type to file module
        "command": "serverinspector.checkers.command",
        "service": "serverinspector.checkers.service",
        "process": "serverinspector.checkers.process",
        "package": "serverinspector.checkers.package",
        "port": "serverinspector.checkers.port",
        "config": "serverinspector.checkers.config",  # Add our new config checker
    }
