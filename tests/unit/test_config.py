...
class TestConfigLoading:
    ...
    def test_config_must_have_tests(self, temp_dir):
        ...
        with pytest.raises(
            ValueError, match="must contain a 'tests' or 'checks' section"
        ):
    ...
    def test_test_must_have_name(self, temp_dir):
        ...
        config_data = {"tests": [{"type": "command", "command": "echo test"}]}
        with open(config_file, "w") as f:
            yaml.dump(config_data, f)
    ...
    def test_test_must_have_type(self, temp_dir):
        ...
        config_data = {"tests": [{"name": "Test", "command": "echo test"}]}
        with open(config_file, "w") as f:
            yaml.dump(config_data, f)
...
class TestVariableProcessing:
    ...
    def test_multiple_variable_substitution(self):
        ...
        variables = {"test_name": "Echo Test", "cmd": "echo", "arg": "world"}
