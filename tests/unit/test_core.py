...
class TestServerInspectRunTests:
    ...
    def test_run_tests_success(self, mock_collect_info, mock_get_runner):
        ...
        config = {
            "title": "Test Suite",
            "tests": [
                {"name": "Test 1", "type": "command", "command": "echo test", "exit_status": 0}
            ]
        }
    ...
    def test_run_tests_handles_exceptions(self, mock_get_checker, mock_collect_info, mock_get_runner):
...
class TestServerInspectOutputResults:
    ...
    def test_output_to_file(self, mock_open, mock_get_formatter, mock_get_runner):
        ...
        inspector.output_results(results, format="json", output_file="/tmp/results.json")
